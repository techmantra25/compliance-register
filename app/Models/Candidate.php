...
class Candidate extends Model
{
   ...
   protected $fillable = [
       'name', 'designation','image', 'email', 'contact_number', 'contact_number_alt_1', 'contact_number_alt_2', 'type', 'assembly_id', 'document_collection_status', 'status', 'parent_candidate_id', 'cloned_by', 'cloned_at', 'clone_remarks', 'is_special_case', 'criminal_case_id', 'special_case_label', 'observation_description', 'observation_others_description', 'last_created_observation_form', 'is_criminal_offence', 'legal_associate_id', 'age', 'serial_no', 'part_no'
   ];
