        ...
        <form wire:submit.prevent="save" enctype="multipart/form-data">
            <div class="keep-together">
                ...
                <div class="section">
                    ...
                    <div style="font-size: 16px; line-height: 2; text-align: justify;">
                        ...
                        <input type="text" class="input-field input-field-large" wire:model="assembly_name"
                            style="width:228px;" readonly> Assembly Constituency.

                    </div>

                    <div style="font-size: 16px; line-height: 2;">
                        Candidate's name <input type="text" class="input-field input-field-large"
                            wire:model="candidate_name" readonly style="width: 300px;">
                        ...
                        name <input type="text" class="input-field input-field-medium" wire:model="relation_name"
                            style="width: 400px;">
                        ...
                        postal address<input type="text" class="input-field input-field-large" style="width: 428px;"
                        ...
                        name is entered at Sl. No<input type="text" class="input-field input-field-small"
                            wire:model="candidate_sl_no"> in Part No.
                        <input type="text" class="input-field input-field-small" wire:model="candidate_part_no"> of the
                        electoral roll for
                        <input type="text" class="input-field input-field-medium" wire:model="assembly_name"
                            style="width: 229px;"> Assembly constituency.
                    </div>

                    <div style=" font-size: 16px; line-height: 2;">
                        My name is <input type="text" class="input-field input-field-large" wire:model="proposer_name">
                        and it is entered at Sl. No.
                        <input type="text" class="input-field input-field-small" wire:model="proposer_sl_no"> in Part No
                        <input type="text" class="input-field input-field-small" wire:model="proposer_part_no"> of the
                        electoral roll for the
                        <input type="text" class="input-field input-field-medium" wire:model="proposer_constituency"
                            style="width: 227px;"> Assembly constituency.
                    </div>
            ...
            <div class="keep-together">
                ...
                <div style="margin-top: 3px;">(a) I am a citizen of India and have not acquired the citizenship of any
                    foreign State;</div>
                <div style="margin-top: 2px;">(b) that I have completed <input type="number"
                        class="input-field input-field-small" wire:model="candidate_age"> years of age;</div>
                ...
                <div style="margin-top: 10px;">
                    (c) (i) I am set up at this election by the <input type="text"
                        class="input-field input-field-medium" wire:model="party_name" style="width: 283px;"> party,
                    which is recognised
                    <label>
                ...
                <div style="margin-top: 3px;">
                    ...
                    <input type="text" class="input-field input-field-medium" wire:model="language_name"> (name of the
                    language); and
                </div>
                <div style="margin-top: 3px;">
            ...
            <div class="keep-together">
                ...
                <div style="margin-left: 20px; line-height: 1.21;">(i) Case/First information report No./Nos. <input
                        type="text" class="input-field input-field-large" wire:model.defer="case_no"></div>
                <div style="margin-left: 20px; line-height: 1.21;">(ii) Police station(s) <input type="text"
                        class="input-field" style="width: 139px;" wire:model.defer="police_station"> District(s) <input
                        type="text" class="input-field" style="width: 139px;" wire:model.defer="district"> State(s)
                    <input type="text" class="input-field" style="width: 139px;" wire:model.defer="state"></div>
                <div style="margin-left: 20px; line-height: 1.21;">(iii) Section(s) of the concerned Act(s) and brief
                    description of the offence(s) for which he has been convicted <input type="text"
                        class="input-field input-field-large" wire:model.defer="sections"></div>
                <div style="margin-left: 20px; line-height: 1.21;">(iv) Date(s) of conviction(s) <input type="date"
                        class="input-field input-field-medium" style="width: 139px;" wire:model.defer="conviction_date">
                </div>
                <div style="margin-left: 20px; line-height: 1.21;">(v) Court(s) which convicted the candidate <input
                        type="text" class="input-field input-field-medium" style="width: 331px;"
                        wire:model.defer="court"></div>
                <div style="margin-left: 20px; line-height: 1.21;">(vi) Punishment(s) imposed [indicate period of
                    imprisonment(s) and/or quantum of fine(s)] <input type="text" class="input-field input-field-large"
                        wire:model.defer="punishment"></div>
                <div style="margin-left: 20px; line-height: 1.21;">(vii) Date(s) of release from prison <input
                        type="date" class="input-field input-field-medium" wire:model.defer="release_date"></div>
                <div style="margin-left: 20px; line-height: 1.21;">(viii) Was/were any appeal(s)/revision(s) filed
                    against above conviction(s)
                    <label>
                ...
                <div style="margin-left: 20px; line-height: 1.21;">(ix) Date and particulars of the
                    appeal(s)/application(s) for revision filed <input type="text" class="input-field input-field-large"
                        style="width: 430px;" wire:model.defer="appeal_details"></div>
                <div style="margin-left: 20px; line-height: 1.21;">(x) Name of the court(s) before which the
                    appeal(s)/application(s) for revision filed <input type="text"
                        class="input-field input-field-medium" wire:model.defer="appeal_court"></div>
                <div style="margin-left: 20px; line-height: 1.21;">(xi) Whether the said appeal(s)/application(s) for
                    revision has/have been disposed of or is/are pending <input type="text"
                        class="input-field input-field-medium" wire:model.defer="appeal_status"></div>
                <div style="margin-left: 20px; line-height: 1.21;">(xii) If the said appeal(s)/application(s) for
                    revision has/have been disposed of—</div>
                <div style="margin-left: 60px;">
                    <div>(a) Date(s) of disposal <input type="date" class="input-field input-field-medium"
                            wire:model.defer="disposal_date"></div>
                    <div>(b) Nature of order(s) passed <input type="text" class="input-field input-field-medium"
                            wire:model.defer="order_nature"></div>
                </div>
                @endif
            </div>
            ...
            <div class="keep-together">
                <div style="margin-top: 20px;">
                    ...
                    <div style="margin-top: 10px;">
                        ...
                        <input type="text" class="input-field input-field-large" wire:model="office_details">
                    </div>
                </div>
                ...
                <div style="margin-top: 15px;">
                    ...
                    <div style="margin-top: 10px;">
                        ...
                        <input type="text" class="input-field input-field-medium" wire:model="insolvent_details">
                    </div>
                </div>
                ...
                <div style="margin-top: 15px;">
                    <div>
                        ...
                        <label>
                            <input type="radio" name="foreign_allegiance" wire:model="foreign_allegiance" value="yes">
                            Yes
                        </label>
                        /
                        <label>
                    ...
                    <div style="margin-top: 10px;">
                        - If Yes, give details
                        <input type="text" class="input-field input-field-large" wire:model="foreign_details">
                    </div>
                </div>
                ...
                <div style="margin-top: 15px;">
                    <div>
                        ...
                        <label>
                            <input type="radio" name="disqualified_president" wire:model="disqualified_president"
                                value="yes"> Yes
                        </label>
                        /
                        <label>
                    ...
                    <div style="margin-top: 10px;">
                        ...
                        <input type="text" class="input-field input-field-medium" wire:model="disqualified_period">
                    </div>
                </div>
                ...
                <div style="margin-top: 8px;">
                    <div style="line-height: 1.8;">
                        ...
                        <label>
                            <input type="radio" name="dismissed_for_corruption" wire:model="dismissed_for_corruption"
                                value="yes"> Yes
                        </label>
                        /
                        <label>
                    ...
                    <div style="margin-top: 5px;">
                        ...
                        <input type="date" class="input-field input-field-medium" wire:model="dismissed_date">
                    </div>
                </div>
                ...
                <div style="margin-top: 8px;">
                    ...
                    <div style="line-height: 1.8;">
                        ...
                        <input type="text" class="input-field input-field-large" wire:model="govt_contract_details">
                    </div>
                </div>
                ...
                <div style="margin-top: 8px;">
                    <div style="line-height: 1.8;">
                        (8) Whether the candidate is a managing agent, manager or Secretary of any company or
                        Corporation?
                    ...
                    <div style="line-height: 1.8;">
                        ...
                        <input type="text" class="input-field input-field-large" wire:model="company_details">
                    </div>
                </div>
                ...
                <div style="margin-top: 8px;">
                    <div style="line-height: 1.8;">
                        (9) Whether the candidate has been disqualified by the Commission under section 10A of the said
                        Act?

                        <label>
                            <input type="radio" name="commission_disqualified" wire:model="commission_disqualified"
                                value="yes"> Yes
                        </label>
                        /
                        <label>
                    ...
                    <div style="line-height: 1.8;">
                        ...
                        <input type="date" class="input-field input-field-medium"
