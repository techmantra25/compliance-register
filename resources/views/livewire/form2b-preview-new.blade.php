<div>
    ...
    <div class="d-flex flex-wrap justify-content-between align-items-center mb-4">
        ...
        <div>
            <a href="{{ route('admin.form-2b-create', $nomination->assembly_id) }}" class="btn btn-sm btn-danger shadow-sm">
                <i class="bi bi-arrow-left-circle me-1"></i> Back
            </a>
        </div>
    </div>
    <div id="printArea">
        <div id="nominationComponent" wire:id="{{ $this->getId() }}">
            <div class="form-container">
                ...
                <div class="keep-together">
                    <div class="form-header">
                        ...
                        <div style="font-style: italic; font-size: 16px; line-height: 1.21;">Election to the Legislative Assembly of
                            <span class="flex-input">WEST BENGAL</span>(State)
                        </div>
                    ...
                    <div class="section">
                        ...
                        <div style="font-size: 16px; line-height: 2; text-align: justify;">
                            ...
                            <span class="flex-input">{{$nomination->assembly_name}}</span>
                            
                        </div>

                        <div style="font-size: 16px; line-height: 2;">
                            Candidate's name: <span class="flex-input">{{$nomination->candidate_name}}</span>
                        ...
                        <div style=" font-size: 16px; line-height: 2;">
                            My name is <span class="flex-input"></span>
                    ...
                    <div class="full-strike">
                        ...
                        <div class="section" style="margin-top: 40px; line-height: 1.21;">
                            ...
                            <div style="margin-top: 15px;">
                                ...
                                His postal address: 
                               <span class="flex-input">{{ ucwords($nomination->postal_address) }}</span>
                ...
                <div class="keep-together">
                    ...
                    <div class="full-strike2">
                        ...
                        <table style="margin-top: 0;">
                            ...
                            @php
                                if (is_array($nomination->proposers)) {
                                    $proposers = $nomination->proposers;
                                } elseif (!empty($nomination->proposers) && $nomination->proposers !== '[]') {
                                    $decoded = json_decode($nomination->proposers, true);
                                    $proposers = is_array($decoded) ? $decoded : [];
                                } else {
                                    $proposers = [];
                                }
                                function getP($arr, $i, $key) {
                                    return $arr[$i][$key] ?? '';
                                }
                            @endphp
                            ...
                            <tbody>
                                <tr>
                                    <td>1.</td>
                                    <td><span class="flex-input">{{ getP($proposers,0,'part_no') }}</span></td>
                                    <td><span class="flex-input">{{ getP($proposers,0,'sl_no') }}</span></td>
                                    <td><span class="flex-input">{{ ucwords(getP($proposers,0,'name')) }}</span></td>
                                    <td><input type="text" class="input-field" style="width: 100%;" value="{{ getP($proposers,0,'constituency') }}"></td>
                                    <td><input type="text" class="input-field" style="width: 100%;"></td>
                                </tr>

                                <tr>
                                    <td>2.</td>
                                    <td><span class="flex-input">{{ getP($proposers,1,'part_no') }}</span></td>
                                    <td><span class="flex-input">{{ getP($proposers,1,'sl_no') }}</span></td>
                                    <td><span class="flex-input">{{ ucwords(getP($proposers,1,'name')) }}</span></td>
                                    <td><input type="text" class="input-field" style="width: 100%;" value="{{ getP($proposers,1,'constituency') }}"></td>
                                    <td><input type="text" class="input-field" style="width: 100%;"></td>
                                </tr>

                                <tr>
                                    <td>3.</td>
                                    <td><span class="flex-input">{{ getP($proposers,2,'part_no') }}</span></td>
                                    <td><span class="flex-input">{{ getP($proposers,2,'sl_no') }}</span></td>
                                    <td><span class="flex-input">{{ ucwords(getP($proposers,2,'name')) }}</span></td>
                                    <td><input type="text" class="input-field" style="width: 100%;" value="{{ getP($proposers,2,'constituency') }}"></td>
                                    <td><input type="text" class="input-field" style="width: 100%;"></td>
                                </tr>

                                <tr>
                                    <td>4.</td>
                                    <td><span class="flex-input">{{ getP($proposers,3,'part_no') }}</span></td>
                                    <td><span class="flex-input">{{ getP($proposers,3,'sl_no') }}</span></td>
                                    <td><span class="flex-input">{{ ucwords(getP($proposers,3,'name')) }}</span></td>
                                    <td><input type="text" class="input-field" style="width: 100%;" value="{{ getP($proposers,3,'constituency') }}"></td>
                                    <td><input type="text" class="input-field" style="width: 100%;"></td>
                                </tr>

                                <tr>
                                    <td>5.</td>
                                    <td><span class="flex-input">{{ getP($proposers,4,'part_no') }}</span></td>
                                    <td><span class="flex-input">{{ getP($proposers,4,'sl_no') }}</span></td>
                                    <td><span class="flex-input">{{ ucwords(getP($proposers,4,'name')) }}</span></td>
                                    <td><input type="text" class="input-field" style="width: 100%;" value="{{ getP($proposers,4,'constituency') }}"></td>
                                    <td><input type="text" class="input-field" style="width: 100%;"></td>
                                </tr>

                                <tr>
                                    <td>6.</td>
                                    <td><span class="flex-input">{{ getP($proposers,5,'part_no') }}</span></td>
                                    <td><span class="flex-input">{{ getP($proposers,5,'sl_no') }}</span></td>
                                    <td><span class="flex-input">{{ ucwords(getP($proposers,5,'name')) }}</span></td>
                                    <td><input type="text" class="input-field" style="width: 100%;" value="{{ getP($proposers,5,'constituency') }}"></td>
                                    <td><input type="text" class="input-field" style="width: 100%;"></td>
                                </tr>

                                <tr>
                                    <td>7.</td>
                                    <td><span class="flex-input">{{ getP($proposers,6,'part_no') }}</span></td>
                                    <td><span class="flex-input">{{ getP($proposers,6,'sl_no') }}</span></td>
                                    <td><span class="flex-input">{{ ucwords(getP($proposers,6,'name')) }}</span></td>
                                    <td><input type="text" class="input-field" style="width: 100%;" value="{{ getP($proposers,6,'constituency') }}"></td>
                                    <td><input type="text" class="input-field" style="width: 100%;"></td>
                                </tr>

                                <tr>
                                    <td>8.</td>
                                    <td><span class="flex-input">{{ getP($proposers,7,'part_no') }}</span></td>
                                    <td><span class="flex-input">{{ getP($proposers,7,'sl_no') }}</span></td>
                                    <td><span class="flex-input">{{ ucwords(getP($proposers,7,'name')) }}</span></td>
                                    <td><input type="text" class="input-field" style="width: 100%;" value="{{ getP($proposers,7,'constituency') }}"></td>
                                    <td><input type="text" class="input-field" style="width: 100%;"></td>
                                </tr>

                                <tr>
                                    <td>9.</td>
                                    <td><span class="flex-input">{{ getP($proposers,8,'part_no') }}</span></td>
                                    <td><span class="flex-input">{{ getP($proposers,8,'sl_no') }}</span></td>
                                    <td><span class="flex-input">{{ ucwords(getP($proposers,8,'name')) }}</span></td>
                                    <td><input type="text" class="input-field" style="width: 100%;" value="{{ getP($proposers,8,'constituency') }}"></td>
                                    <td><input type="text" class="input-field" style="width: 100%;"></td>
                                </tr>

                                <tr>
                                    <td>10.</td>
                                    <td><span class="flex-input">{{ getP($proposers,9,'part_no') }}</span></td>
                                    <td><span class="flex-input">{{ getP($proposers,9,'sl_no') }}</span></td>
                                    <td><span class="flex-input">{{ ucwords(getP($proposers,9,'name')) }}</span></td>
                                    <td><input type="text" class="input-field" style="width: 100%;" value="{{ getP($proposers,9,'constituency') }}"></td>
                                    <td><input type="text" class="input-field" style="width: 100%;"></td>
                                </tr>
                            </tbody>
                        </table>
                    ...
                    <div>I, the candidate mentioned in <span class="strike-out">Part I</span>/<span>Part II</span> (Strike out which is not applicable) assent to this nomination and hereby declare that:</div>
                    ...
                    <div style="margin-top: 10px;">
                        ...
                        <span class="flex-input">{{$nomination->party_name}}</span>

                        party, which is recognised 
                        <span class="{{ strtolower($nomination->party_type) != 'national' ? 'strike-out' : '' }}">National Party</span>/<span class="{{ strtolower($nomination->party_type) != 'state' ? 'strike-out' : '' }}">State Party</span> 
                        ...
                        <div class="full-strike">
                            ...
                            <div style="margin-left: 20px;">
                                (i) <span class="flex-input">{{$nomination->symbol_1}}</span> 
                                (ii) <span class="flex-input">{{$nomination->symbol_2}}</span> 
                                (iii) <span class="flex-input">{{$nomination->symbol_3}}</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="full-strike">
                        <div style="margin-top: 15px;">
                            * I further declare that I am a member of the 
                            <span class="flex-input">{{$nomination->caste}}</span>
                            **Caste/tribe which is a scheduled 
                        </div>
                        <div style="margin-top: 3px;">
                            **caste/tribe of the State of 
                            <span class="flex-input">{{$nomination->caste_state}}</span>
                            in relation to 
                            <span class="flex-input">{{$nomination->caste_area}}</span>
                            (area) in that State.
                        </div>
                    </div>
                ...
                <div class="keep-together">
                    <div style="margin-top: 15px; ">
                        ...
                        <span class="flex-input">WEST BENGAL</span> 
                ...
                <div class="keep-together">
                    ...
                    <div class="section" style="margin-top: 20px;">
                        ...
                        <div style="margin-top: 10px; text-align: justify;">
                            ...
                            <span class="flex-input">{{ucwords($nomination->candidate_name)}}</span>
    ...
    <div class="action-buttons no-print">
        ...
        <a href="{{ route('admin.form-2b-create', $nomination->assembly_id) }}" class="btn btn-secondary">
            Modify Details
        </a>
    </div>
@push('scripts')
